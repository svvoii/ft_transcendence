...
export default class extends AbstractView {
  ...
  getDomElements() {
    ...
    const elements = [
      { tag: 'h1', content: 'Terms of Service for ft_transcenDANCE' },
      { tag: 'p', content: '<strong>Effective Date</strong>: 5 Dec 2024' },
      { tag: 'h3', content: '1. <strong>Introduction</strong>' },
      ...
      { tag: 'h3', content: '2. <strong>Acceptance of Terms</strong>' },
      ...
      { tag: 'h3', content: '3. <strong>Game Usage</strong>' },
      ...
      { tag: 'h3', content: '4. <strong>Account Creation</strong>' },
      ...
      { tag: 'h3', content: '5. <strong>Game Content</strong>' },
      ...
      { tag: 'h3', content: '6. <strong>User Conduct</strong>' },
      ...
      { tag: 'h3', content: '7. <strong>Privacy</strong>' },
      ...
      { tag: 'h3', content: '8. <strong>Disclaimer of Warranties</strong>' },
      ...
      { tag: 'h3', content: '9. <strong>Limitation of Liability</strong>' },
      ...
      { tag: 'h3', content: '10. <strong>Modifications to Terms</strong>' },
      ...
      { tag: 'h3', content: '11. <strong>Termination</strong>' },
      ...
      { tag: 'h3', content: '12. <strong>Contact Information</strong>' },
